<div class="card o-hidden border-0 shadow-lg my-5">
    ...
    foreach ($lab_benih as $lab) {
    ?>
                    <form class="user" method="post" action="<?= base_url('lab_benih_controller/edit'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="benihID" name="benihID" value="<?= $lab['benihID']; ?>" hidden>
